...
public class RedeSimulador
{
    ...
    private final Remetente sender;
    private final Receptor receiver;
    ...
    public RedeSimulador(int numMessages,
                            double loss,
                            double corrupt,
                            double avgDelay,
                            int trace,
                            long seed)
    {
        ...
        sender  = new Remetente(A, eventList, lossProb, corruptProb,
                             traceLevel, rand);
        receiver= new Receptor(B, eventList, lossProb, corruptProb,
                               traceLevel, rand);
        ...
        while (true)
        {
            ...
            switch (next.getType())
            {
                ...
                case FROMAPP:
                    ...
                    sender.Output(new Mensagem(new String(nextMessage)));
                    break;
    ...
    private void generateNextArrival()
    {
        ...
        Evento next = new Evento(time + x, FROMAPP, A);
